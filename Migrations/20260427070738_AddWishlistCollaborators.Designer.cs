...
namespace wisheo_backend_v2.Migrations
{
    ...
    [Migration("20260427070738_AddWishlistCollaborators")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("wisheo_backend_v2.Models.Reservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("wisheo_backend_v2.Models.Follow", b =>
                {
                    b.HasOne("wisheo_backend_v2.Models.User", "Followed")
                        .WithMany("Followers")
                        .HasForeignKey("FollowedId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("wisheo_backend_v2.Models.User", "Follower")
                        .WithMany("Following")
            ...
            modelBuilder.Entity("wisheo_backend_v2.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("wisheo_backend_v2.Models.WishItem", "WishItem")
